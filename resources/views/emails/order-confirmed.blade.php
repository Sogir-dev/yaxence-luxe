                ...
                <table role="presentation" width="600" cellpadding="0" cellspacing="0" style="max-width:600px; width:100%; background-color:#0a0a0a; border:1px solid #4a3a19;">
                    ...
                    <tr>
                        <td align="center" style="padding: 0 30px 30px;">
                            <p style="margin:0 0 8px; font-size:11px; letter-spacing:3px; text-transform:uppercase; color:#d4af6a;">Order Confirmed</p>
                            <h1 style="margin:0 0 10px; font-size:26px; color:#ffffff; font-weight:normal;">Thank you, {{ $order->customer_name }}</h1>
                            <p style="margin:0; font-size:14px; color:#a3a3a3; line-height:1.6;">
                                Your order #{{ $order->id }} has been confirmed and payment received. Here's a summary for your records.
                            </p>
                        </td>
                    </tr>
